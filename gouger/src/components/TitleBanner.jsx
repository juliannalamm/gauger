    ...
    <header className="w-screen bg-gradient-to-r from-red-100 via-green-50 to-green-100 shadow-sm border-b border-green-200 pt-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
        <div className="flex justify-center items-center gap-3">
          ...
          />
          <h2 className="text-3xl sm:text-4xl font-bold text-red-800 tracking-wide">
            Gouger
          </h2>
        </div>

        <p className="mt-2 text-base sm:text-lg text-green-900 max-w-xl mx-auto font-light">
